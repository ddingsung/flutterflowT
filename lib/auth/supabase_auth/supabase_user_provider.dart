...
class FigmatestSupabaseUser extends BaseAuthUser {
  FigmatestSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> figmatestSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = FigmatestSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
